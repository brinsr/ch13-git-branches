Adding a line at top of file in master branch
# Exercise 1
...
2. Open up _this_ `README.md` file in VS Code or another text editor. Be sure to open the one in the `exercise-1` folder!
...
this is on experiment branch-I had cereal
